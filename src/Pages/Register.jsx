...
const Register = () => {
  ...
  return (
            <div className={`body2 ${showSuccessPopup ? 'dimmed' : ''}`}>
        ...
        <div className="reg-container">
          ...
          <div className="form2">
            ...
            <form onSubmit={handleReg}>
              ...
              <button className="submit-btn reg-btn" type="submit">
                Register Now
              </button>
            </form>
            {showSuccessPopup && (
              <div className="success-popup">
                ...
                <button onClick={() => setShowSuccessPopup(false)} className="cont-btn">Back</button>
              </div>
            )}
